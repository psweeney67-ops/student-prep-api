...
// It now uses a granular multi-step process with a retry mechanism for reliability.
...
function call_gemini_api(string $api_key, array $payload, string $model = 'gemini-2.5-flash-preview-05-20'): array {
    ...
    try {
        ...
        if ($finish_reason !== 'STOP') {
            throw new Exception("API response was truncated or incomplete. Finish reason: " . $finish_reason);
        }

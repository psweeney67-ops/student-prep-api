...
try {
    ...
    // Goal: Find sources and synthesize the factual part of the briefing.
    
    $company_name = $job_data['company_name'];
    $industry_trends = implode(', ', $job_data['industry_trends']);
    
    $research_prompt = "Act as a research analyst. Your task is to find at least 10 recent, high-quality sources (news articles, financial reports, official company statements) to create a factual market briefing for the company '$company_name'. The briefing should focus on these industry trends: '$industry_trends'. The output must be a well-structured Markdown document. It must include sections for: Company Overview, Strategic Response to Trends, Key People, Competitor Analysis, and Recent News. Cite your sources clearly within the document.";

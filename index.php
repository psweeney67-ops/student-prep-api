...
The JSON object must conform to the following structure:
{
  ...
  \"key_metrics\": {
    \"market_cap\": \"Current market capitalization. State 'N/A for private companies' if not applicable.\",
    \"annual_revenue\": \"Latest reported annual revenue.\",
    \"employee_count\": \"Total number of employees.\",
    \"revenue_growth\": \"Year-over-year revenue growth percentage. State 'N/A' if not available.\",
    \"founded_year\": \"The year the company was founded.\",
    \"headquarters\": \"Primary headquarters location (City, Country).\",
    \"industry_sector\": \"The primary industry/sector the company operates in.\",
    \"profit_margin\": \"Operating or net profit margin percentage. Specify which and state 'N/A' if not available.\",
    \"key_financial_kpis\": [
      {
        \"kpi_name\": \"Name of an important Key Performance Indicator (e.g., Gross Margin, EBITDA, Free Cash Flow)\",
        \"kpi_value\": \"The current value or figure for the KPI.\",
        \"kpi_trend\": \"A brief description of the trend (e.g., 'Increasing', 'Stable', 'Decreasing').\"
      }
    ]
  },
  \"key_people\": [
    {
      ...
      \"linkedin_profile_url\": \"The URL of their LinkedIn profile. State 'Not found' if it cannot be reliably located.\",
      \"previous_roles\": [
        {
          \"title\": \"Their most recent previous role title.\",
          \"company\": \"The company where they held that role.\",
          \"duration\": \"The time period of the role (e.g., '2019-2021').\"
        },
        {
          \"title\": \"The role before that.\",
          \"company\": \"The company where they held that role.\",
          \"duration\": \"The time period of the role (e.g., '2015-2019').\"
        }
      ]
    }
  ],

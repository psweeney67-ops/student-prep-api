...
Push to GitHub: Create a new repository on GitHub. Push the index.php, composer.json, and the new build.sh files to it.

Make Build Script Executable (CRITICAL STEP):
Before you push to GitHub, you must run this command in your local terminal to tell Git that build.sh is a program that can be run:

git update-index --chmod=+x build.sh

After running it, commit and push the change.
...
Click "Create Web Service" or manually trigger a new deploy. Render will now use your script to build the service.
